...
in
{
  ...
  hardware.nvidia = {
    ...
    nvidiaSettings = true;
    # Pin to 580.119.02 — matches the kernel module currently loaded so the
    # NVML userspace/driver versions don't drift after nixpkgs bumps. To
    # move forward, bump these hashes against a newer nixpkgs commit and
    # reboot to reload the kernel module.
